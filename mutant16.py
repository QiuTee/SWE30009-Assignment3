...
def recommend_products(user_id, pred_ratings_df, num_recommendations=2):
    ...
    #mutant 16 : Change return value by predicting only those products with a prediction score greater than 3
    return user_ratings[user_ratings > 3 ].index[:num_recommendations]
