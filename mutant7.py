...
#7.	Mutant 7 : Change the number of suggestions returned 
#-	In this mutant I change the number of recommendations returned by changing `num_recommendation` in the “recommend_product” function
def recommend_products(user_id, pred_ratings_df, num_recommendations=5):
